...
class FrameJoueurActif(Frame):
    ...
    def __init__(self, parent):
        ...
        self.scale = Scale(self, from_=10, to=500, length=100, orient=HORIZONTAL)
...
class FenetrePrincipale(Tk):
    ...
    def afficher_attaque(self, joueur_attaque, force_attaque, joueur_defense, force_defense, suite):
        ...
        self.after(self.frame_joueur.scale.get(), lambda: self.redessiner(suite))
    ...
    def afficher_gagnant(self):
        ...
        self.destroy()
        self.canvas_carte.permettre_clics(self.__init__())
